...
**Purpose**: Reads the Enrolment Tracker from SharePoint, filters to active subjects, and runs the `subjectListParser` Office Script to populate the `subject_list` table.
